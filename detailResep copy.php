    ...
    <div class="blog-single gray-bg">
        <div class="container">
            <div class="row align-items-start">
                ...
                <!-- comsec bug : data must be submited twice to view the one before -->
                <div class="col-lg-4 m-15px-tb blog-aside">
                    <!-- Author -->
                    <div class="comment-main">
                            <h3>Comments</h3>
                       
                        <form action="detailResep.php?id=<?php echo $id;?>" method="POST" onsubmit="return post();">
                            ...
                            <p>
                                <label>Comment</label>
                                <textarea name="comment" class = "comment_text" required></textarea>
                            </p>

                            <p>
                                <input type="button" class="add-btn" id="submit"value="Publish" />
                                <?php
                                if (isset($_POST["submit"]))
                                {
                                    ...
                                    mysqli_query($conn, "INSERT INTO comments(author, id_resep, comment, date_created, reply) VALUES ('" . $author . "',   $resep_id , '". $comment ."', NOW(), '" . $reply . "')");
                     ...
                     <div class="comment_div"> 
                        <p class="name">Posted By:<?php echo $author;?></p>
                                        ...
                                        for (var i = 0;
                                            ...
                                            if (parent == "0") {
                                                comments = "<div class='comment-row'>" +
                                                    "<div class='comment-info'><span class='comment-row-label'>from</span> <span class='posted-by'>" +
                                                    data[i]['comment_sender_name'] +
                                                    " </span> <span class='comment-row-label'>at</span> <span class='posted-at'>" +
                                                    data[i]['comment_at'] + "</span></div>" +
